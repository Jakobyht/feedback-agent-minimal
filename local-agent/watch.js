...
function formatPrompt(issue) {
  return [
    ...
    "2. First decide whether the feedback is an objective, reproducible problem in the program.",
    "3. If you can locate the problem in code, tests, routing, data fetching, configuration, or docs, treat it as actionable:",
    ...
    "4. If the feedback is subjective, a preference, a future idea, or not verifiable as an existing defect, do not change product code:",
    ...
    `5. If the issue lacks enough information to verify, ask a specific question, remove ${triagingLabel}, add ${needsClarificationLabel}.`,
    `6. If it is too broad, explain the smaller needed scope, remove ${triagingLabel}, add ${needsScopeLabel}.`,
    `7. If duplicate, link the existing issue or PR, remove ${triagingLabel}, add ${duplicateLabel}.`,
    `8. If unsafe or risky, explain the risk, remove ${triagingLabel}, add ${needsHumanReviewLabel}.`,
    "",
    "Rules:",
    "- Do not push to main.",
